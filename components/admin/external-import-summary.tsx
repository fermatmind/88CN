...
import type { ImportQuarantineSummary } from "@/lib/index-data/import-summary";

export interface ExternalImportRowView {
  id: string;
...
interface ExternalImportSummaryProps {
  rows: ExternalImportRowView[];
  summary: ImportQuarantineSummary;
  fixtureMode?: boolean;
}

export function ExternalImportSummary({
  rows,
  summary,
  fixtureMode = false,
}: ExternalImportSummaryProps) {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
      ...
      <div className="mb-6 flex flex-wrap items-center gap-2">
        ...
        {fixtureMode ? (
          <span className="rounded-md border border-amber-500/40 px-2 py-0.5 text-[10px] font-mono uppercase tracking-wide text-amber-300">
            dev fixture
          </span>
        ) : null}
      </div>
